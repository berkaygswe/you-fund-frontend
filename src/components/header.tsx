...
export function Header() {
    return (
        <header className="flex items-center gap-2 justify-between py-4 px-6 border-b border-sidebar-border bg-sidebar sticky top-0 z-50 transition-colors duration-300">
